                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <input oninput="campos()" type="name" class="form-control" id="txtnome" name="txtnome"
                                    aria-describedby="emailHelp" placeholder="Ex: João Pedro" required>
                            </div>
                            <div class="col-sm-6 mb-3">
                                <label for="exampleInputEmail1" class="form-label">Sobrenome</label>
                                <input oninput="campos()" type="name" class="form-control" id="txtsobrenome"
                                    name="txtsobrenome" aria-describedby="emailHelp" placeholder="Silva" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-6 mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nascimento</label>
                                <input oninput="campos()" type="date" id="datepicker" class="form-control"
                                    name="txtdatanasc" required>
                            </div>
                            <div class="col-sm-6 col-6 mb-3">
                                <label for="exampleInputEmail1" class="form-label">Escolaridade</label>
                                <select onselect="campos()" class="form-select" name="txtescolaridade" required
                                    id="escolaridade">
                                    ...
                                    <option value="12">Ignorado</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Telefone</label>
                            <input oninput="campos()" type="tel" class="form-control" id="txttelefone"
                                name="txttelefone" aria-describedby="emailHelp" placeholder="DDD + Número" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Email</label>
                            <input oninput="campos()" type="email" class="form-control" id="txtemail" name="txtemail"
                                aria-describedby="emailHelp" placeholder="Ex: joaopedrosilva@gmail.com" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Senha</label>
                            <input oninput="campos()" type="password" class="form-control" id="txtsenha"
                                placeholder="Senha de pelo menos 8 caracteres" minlength="8" name="txtsenha"
                                aria-describedby="emailHelp" required>
                        </div>
                        <input type="submit" class="btn btn-primary" value="Cadastrar" id="btnsubmit"
                            name="btn-cadastro"></input>
                    </div>
