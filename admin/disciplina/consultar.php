...
<body>
    <div class="col-md-12">
        <h1>Disciplinas cadastradas
            <button class="btn btn-primary" style="float: right; cursor: pointer; text-decoration: none" name="btn-new-disc-modal" data-bs-toggle="modal" data-bs-target="#modal-save-disciplina">+ Nova</button>
        </h1>
        ...
        <div class="card shadow">
            <table class="table table-striped text-center p-0 m-0">
                ...
                <tbody>
                    ...
                    $dados = $materia->ConsultarTodasDisciplinas();
                    ...
                    ?>
                        <tr class="">
                            ...
                            <td>
                                <a href="?p=disciplina/excluir&id_disc=<?= $mostrar['id_disc'] ?>" class="btn btn-danger" data-confirm="Excluir registro?">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="" class="form-control" name="txt-disciplina-new" placeholder="Ex: matemática" minlength="1">
                    </div>
...
if (filter_input(INPUT_POST, 'btn-nova-disciplina')) {
    ...
    $materia->setDisciplina($ucwords);

    if ($materia->cadastrarNovaDisciplina()) {


?>

        <meta http-equiv="refresh" content="0.5;URL=?p=disciplina/consultar" <div class="toast align-items-center text-white bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true">
