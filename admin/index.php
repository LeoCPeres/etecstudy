...
<script>
  ...
  toolbar:
    "undo redo | fontselect | h1 h2 h3 | bold italic underline backcolor strikethrough blockquote| alignleft aligncenter alignright alignjustify |  bullist numlist  | link image media | removeformat code",
    menubar: false,
    skin: "bootstrap",
    image_title: true,
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="d-flex">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="./admin/painel.php" class="nav-link" style="color: white">Admin</a>
            </li>
          </ul>
        </div>
      </div>
