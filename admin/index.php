...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/3iik4gctq1mgfjgkwf142nxi3qnwfk3k1bt5sdlxvy40yts6/tinymce/5/tinymce.min.js"
    ...
    tinymce.init({
        ...
        toolbar: "undo redo | fontselect | h1 h2 h3 | bold italic underline backcolor strikethrough blockquote| alignleft aligncenter alignright alignjustify |  bullist numlist  | link | removeformat code",
        menubar: false,
        skin: "bootstrap",
        image_title: true,
...
<body>
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark navedit fixed-top"
